                ...
                <div class="col-xl-2 col-7 col-md-8 col-lg-2">
                    <div class="wsus_logo_area">
                        <a class="wsus__header_logo" href="index.html">
                            <img src="{{asset('frontend/images/favicon.png')}}" alt="logo" class="img-fluid w-100">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-sm-6 col-lg-4">
                    <div class="wsus__product_item">
                        ...
                        <a class="wsus__pro_link" href="product_details.html">
                            <img src="{{asset('images/pro3.jpg')}}" alt="product" class="img-fluid w-100 img_1" />
                            <img src="{{asset('images/pro3_3.jpg')}}" alt="product" class="img-fluid w-100 img_2" />
                        </a>
